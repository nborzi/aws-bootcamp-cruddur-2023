...
Added boto3 to requirements and run pip install -r requirements.txt 
organised the bin folder as we will be using a lot more scripts with DynamoDB (and changed where the namespath were used)
...
# run at ./bin/ddb/drop cruddur-message
```
